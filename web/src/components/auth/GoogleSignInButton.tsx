...
export default function GoogleSignInButton({
    ...
    return (
        <a
            href={href}
            className="w-full flex items-center justify-center gap-2.5 rounded-lg bg-vox-surface border border-vox-outline/60 hover:border-vox-text-dim/60 text-vox-text px-4 py-2.5 text-[13.5px] font-medium transition-colors"
